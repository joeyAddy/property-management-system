...
import { FaBolt, FaBuilding, FaCanadianMapleLeaf, FaCrown, FaHandshake, FaHome } from "react-icons/fa";
import { BsStack } from "react-icons/bs";

const CommonFeatures = () => {
  return (
    <section className="h-auto mt-10 md:px-36 py-10  bg-slate-50">
      ...
      <div className="grid lg:grid-cols-3 gap-8 mt-5">
        ...
        <CommonFeaturesCard icon={<FaCanadianMapleLeaf />} title="Living Inside a Nature" />
