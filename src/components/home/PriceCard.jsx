  ...
  return (
    ...
    >
      ...
      <div className="font-bold w-full flex flex-col py-6 space-y-3 items-center border-b-2 ">
        <p className="mx-auto text-gray-800 text-5xl">$99</p>
        <p className="mx-auto text-gray-600 text-xl uppercase">
      ...
      >
        <div className="w-4/5 flex flex-col py-6 mx-10 text-center space-y-3 items-center border-b-2 ">
          <p className="mx-auto text-gray-800 text-lg font-bold ">
        ...
        <div className="w-4/5 flex flex-col py-6 mx-10 text-center space-y-3 items-center border-b-2">
          <p className="mx-auto text-gray-800 text-lg font-bold flex items-center">
        ...
        <div className="w-4/5 flex flex-col py-6 mx-10 text-center space-y-3 items-center pb-12">
          <button className="text-white font-medium px-6 py-5 bg-blue-600 rounded-md uppercase">
            Get started now
          </button>
        </div>
      </div>
