        ...
        <div className="md:w-1/2 md:mx-auto ">
          ...
          >
            <li className="mb-2 md:-mb-px mr-2 last:mr-0 flex-auto text-center">
              <a
                className={
                  "text-md font-medium uppercase px-5 py-3.5 mb-2 bg-opacity-75 hover:shadow-lg hover:bg-opacity-100 border-2 border-blue-600 rounded block leading-normal transition-all ease-in-out duration-300 delay-150 " +
                  (openTab === 1
